...
import CurrenciesGrid from '../../src/components/CurrenciesGrid';
import { renderWithProviders } from '../store/renderWithProviders';
import { act } from 'react-dom/test-utils';
import { testGetCurrencies } from '../../src/store/currenciesSlice';
import { vi } from 'vitest';
import userEvent from '@testing-library/user-event'
import WalletGrid from '../../src/components/WalletGrid';
import { testGetWallet } from '../../src/store/walletSlice';
...
describe('Wallet Grid component', () => {
    ...
    test('renders wallet if request succeeds', async () => {
        ...
        await act(async () => {
            store.dispatch(testGetCurrencies(initialCurrenciesState));
            store.dispatch(testGetWallet(initialWalletState))
        });
