...
function BuyCurrencies(props) {
  ...
  function changeTotalValue(event) {
    change('totalValue', calculateValue(event.target.value, initialValues.sellPrice, initialValues.currencyCode));
  }
...
function mapStateToProps(state) {
  ...
  return {
    initialValues: {
      ...
      totalValue: calculateValue(popUpCurrency.unit, popUpCurrency.sellPrice, popUpCurrency.code),
